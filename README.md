...
## Engineering observation stack

Use this section to operate Pseudini as an observable system. It covers the path from the editor
command to the model runner and the Mac hardware:
